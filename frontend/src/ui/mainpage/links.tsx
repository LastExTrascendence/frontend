...
const LinkItem = ({ href, title, description }: LinkItemProps) => (
  <Link
    href={href}
    className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-pink-700 hover:dark:bg-pink-800/30"
