      ...
      {links.map((link) => {
        ...
        return (
          <Link
            ...
            href={link.href}
            className={clsx(
              "flex h-20 w-20 grow flex-col items-center justify-center gap-2 rounded-[32px] p-3 text-sm hover:bg-gray-100 hover:text-gray-700 md:flex-none md:justify-start md:p-2 md:px-3 ",
              {
